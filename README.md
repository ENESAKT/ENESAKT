...
- ⚙️ **Backend & Sistem:** RESTful API'ler, JWT, WebSocket (Gerçek Zamanlı İletişim), Microservice mantığı.
- 🗄️ **Veri Yönetimi:** MS SQL, MySQL, Redis (Cache Optimizasyonu), Firebase / Supabase.
- ☁️ **DevOps:** Docker, Kubernetes ile Containerization, AWS RDS, CI/CD Süreçleri.
- 📱 **Mobil & Frontend:** Flutter ile MVVM tabanlı, UI/UX odaklı responsive mobil uygulamalar.
